...
function Tooltip({ text, className = "" }: TooltipProps): JSX.Element {
  return (
    <div
      className={`fixed transform -translate-x-1/2 mt-2 px-4 py-2 bg-[#1E1E1E] text-white text-sm rounded-md z-[99999] min-w-[250px] max-w-[350px] break-words ${className}`}
    >
