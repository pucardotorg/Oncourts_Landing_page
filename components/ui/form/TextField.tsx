...
const TextField: React.FC<TextFieldProps> = ({
  ...
  const baseInputClass = "block w-full px-3 py-2 h-10 text-base border-[1.5px] border-[#3D3C3C] rounded-md focus:outline-none focus:ring-teal-500 focus:border-teal-500";
