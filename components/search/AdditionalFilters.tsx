        ...
        <div className="flex justify-between items-end">
          ...
          <div className="flex gap-2 items-end">
            <button
              ...
              className="px-2 font-roboto font-medium text-[20px] leading-[24px] tracking-[-0.2px] text-[#2563EB] hover:text-blue-800 bg-white rounded-lg border border-[#E2E8F0]"
            >
              {t("APPLY_FILTER")}
            </button>
            <button
              onClick={onResetFilters}
              className="font-roboto font-medium text-[20px] leading-[24px] tracking-[-0.2px] text-[#64748B] hover:text-gray-800"
            >
              {t("RESET_ALL")}
            </button>
          </div>
