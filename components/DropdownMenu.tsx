...
const DropdownMenu: React.FC<DropdownMenuProps> = ({
  ...
  const renderDropdownItem = (item: DropdownItem) => {
      ...
      return (
        <div className="group relative" key={item.label}>
          <div className="flex items-center justify-between mx-[clamp(9.67px,calc(9.67px+((15-9.67)*((100vw-1200px)/662))),15px)] py-[clamp(5.16px,calc(5.16px+((8-5.16)*((100vw-1200px)/662))),8px)] hover:text-[#007E7E] group cursor-pointer border-b border-[#CBD5E1]">
            <span className="font-roboto font-medium tracking-[0.01em] text-[20px] leading-[24px] text-[#3A3A3A]">
              {t(item.label)}
            </span>
          ...
          <div className="absolute left-full top-[clamp(5.16px,calc(5.16px+((8-5.16)*((100vw-1200px)/662))),8px)] min-w-[200px] bg-white shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 -mt-2 border-l border-[#E2E8F0]">
            {item.subItems.map((subItem) => (
              <Link
                ...
                className="block mx-[clamp(9.67px,calc(9.67px+((15-9.67)*((100vw-1200px)/662))),15px)] py-[clamp(5.16px,calc(5.16px+((8-5.16)*((100vw-1200px)/662))),8px)] hover:text-[#007E7E] border-b border-[#CBD5E1] last:border-b-0"
              >
                <div className="flex items-center center ">
                  <span className="text-[#3A3A3A] font-roboto font-medium tracking-[0.01em] hover:bg-gray-50 hover:text-[#007E7E] text-[20px] leading-[24px]">
                    {t(subItem.label)}
                  </span>
                </div>
              </Link>
    ...
    return (
      <Link
        key={item.label}
        href={item.href || "#"}
        className="block hover:text-[#007E7E] border-b border-[#E5E5E5] last:border-b-0 py-[clamp(5.16px,calc(5.16px+((8-5.16)*((100vw-1200px)/662))),8px)] mx-[clamp(9.67px,calc(9.67px+((15-9.67)*((100vw-1200px)/662))),15px)]"
      >
        <span className="text-[#3A3A3A] font-roboto font-medium tracking-[0.01em] hover:bg-gray-50 hover:text-[#007E7E] text-[20px] leading-[24px]">
          {t(item.label)}
        </span>
  ...
  return (
    ...
    >
      <span className="text-[#3A3A3A] font-roboto font-medium tracking-[0.01em] text-[20px] leading-[24px]">
