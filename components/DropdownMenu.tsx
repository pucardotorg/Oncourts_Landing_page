...
const DropdownMenu: React.FC<DropdownMenuProps> = ({
      ...
      return (
        <div className="group relative" key={item.label}>
          <div className="flex items-center justify-between mx-[clamp(9.67px,calc(9.67px+((15-9.67)*((100vw-1200px)/662))),15px)] py-[clamp(5.16px,calc(5.16px+((8-5.16)*((100vw-1200px)/662))),8px)] hover:text-[#007E7E] group cursor-pointer border-b border-[#CBD5E1]">
            <span className="font-sans font-medium tracking-[0.01em] text-[clamp(12.88px,calc(12.88px+((20-12.88)*((100vw-1200px)/662))),20px)] leading-[clamp(18.05px,calc(18.05px+((28-18.05)*((100vw-1200px)/662))),28px)]">
              {t(item.label)}
            </span>
            ...
            {item.subItems.map((subItem) => (
              ...
              >
                <div className="flex items-center center ">
                  <span className="text-[#3A3A3A] font-sans font-medium tracking-[0.01em] hover:bg-gray-50 hover:text-[#007E7E] text-[clamp(12.88px,calc(12.88px+((20-12.88)*((100vw-1200px)/662))),20px)] leading-[clamp(18.05px,calc(18.05px+((28-18.05)*((100vw-1200px)/662))),28px)]">
                    {t(subItem.label)}
                  </span>
                </div>
              </Link>
  ...
  return (
    ...
    >
      <span className="text-[#3A3A3A] font-sans font-medium tracking-[0.01em] text-[clamp(12.88px,calc(12.88px+((20-12.88)*((100vw-1200px)/662))),20px)] leading-[clamp(18.05px,calc(18.05px+((28-18.05)*((100vw-1200px)/662))),28px)]">
