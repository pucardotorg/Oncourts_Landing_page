...
export const downloadAsPDF = async (
  ...
  loadingDiv.className =
    "fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-[9999]";

  try {
    // Show loading message with configurable text
    loadingDiv.innerHTML = `
        <div class="bg-white p-6 rounded-lg shadow-xl flex flex-col items-center justify-center space-y-4 animate-pulse">
