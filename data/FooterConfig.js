export function getFooterConfig(tenantId) {
  return {
    logo: {
    ...
    helpResources: [
      { label: "SUPPORT_FORM", url: "https://forms.gle/uCSgGiqGiMQYjjgeA" },
      {
        ...
        url: `https://oncourts.kerala.gov.in/minio-filestore/v1/files/id?tenantId=${tenantId}&fileStoreId=c21569cd-70f1-4a00-b244-afb0cdaf9da5`,
      },
