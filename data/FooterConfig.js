export const FooterConfig = {
  ...
  quickLinks: [
    ...
    { label: "User Manual", url: "/user-manual" },
  ...
  externalLinks: [
    { label: "eCourts Website", url: "https://ecourts.gov.in/ecourts_home/index.php?p=dist_court/kerala" },
    {
      label: "Kollam District Court Website",
      url: "https://kollam.dcourts.gov.in/",
    },
    { label: "Kerala High Court Website", url: "https://highcourt.kerala.gov.in/" },
    { label: "Supreme Court Website", url: "https://www.sci.gov.in/" },
  ],
  copyright: "© High Court of Kerala 2024",
};
